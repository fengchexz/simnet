...
class Generator(object):
    ...
    def __init__(self, args, checkpoint_path, vocab_size):
        ...
        model = total_Model(args.embed_size,vocab_size,args.hidden_size)
    ...
    def translate_batch( self, images, image_concepts ):
        ...
        with torch.no_grad():
            ...
            V,T = self.model.Encoder2VT( images, captions, image_concepts, lengths)
            SGIR,_,_ = self.model.aimNET(V,T)        
            V = SGIR
            T = SGIR
